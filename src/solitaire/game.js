...
exports.createDeck = function(kind) {
  if (kind === 'shuffled') {
    ...
    return [13, 26, 52, 4, 18, 32, 46, 25, 51, 3, 17, 31, 45,
      50, 2, 16, 30, 44, 1, 15, 29, 43, 14, 28, 42, 27, 41, 40,
      49, 48, 47, 39, 38, 37, 36, 35, 34, 33, 24, 23, 22, 21, 20,
      19, 12, 11, 10, 9, 8, 7, 6, 5];
  } else {
...
exports.create = function(options) {
  ...
  if (options.deck === 'easy') {
    ...
    return game;
      ...
      game = {"deck":[45,47,48,49,50,51],"options":{"draw":3,"game":"solitaire","id":"f8d45ab721d925d6","won":false},"stacks":{"0":{"visible":[28,42,4,44,32,46,8,22,10,24,38,26],"hidden":[]},"1":{"visible":[2],"hidden":[]},"2":{"visible":[52],"hidden":[]},"3":{"visible":[37,25,39],"hidden":[]},"4":{"visible":[3,43,31,19,33,21,9,23],"hidden":[20,16,11,5]},"5":{"visible":[17],"hidden":[12,6]},"6":{"visible":[18],"hidden":[13,7]},"hearts":[41,40],"spades":[27],"diamonds":[15,14],"clubs":[1],"draw":[36,35,34,30,29]}};
